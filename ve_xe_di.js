...
const TOTAL = 2;
const URL =
  "https://vanminh.xeca.vn/booking/booking/book-seats?agencyId=1&theme=vanminh&startPoint=1&endPoint=2&startDate=03%2F09%2F2024";
...
const fillInfoAndSend = async (e) => {
  ...
  await mobileNo.sendKeys("0898557849");
  const customerName = await e.findElement(
    By.xpath(`.//input[@id='custName']`)
  );
  await customerName.sendKeys("Nguyen Ngoc Huynh");
