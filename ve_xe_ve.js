...
const TOTAL = 2;
const URL =
  "https://vanminh.xeca.vn/booking/booking/book-seats?agencyId=1&theme=vanminh&startPoint=2&endPoint=1&startDate=30%2F08%2F2024";
const PCIK_UP_ADDRESS = '172 Trần Bình';
const ARRIVE_ADDRESS = 'GIÁT - NA';
const TIME_FROM = '22'
const TIME_TO = '24'
const PRICE = '300000'
...
const fillInfoAndSend = async (e) => {
  ...
  await mobileNo.sendKeys("0775818991");
  const customerName = await e.findElement(
    By.xpath(`.//input[@id='custName']`)
  );
  await customerName.sendKeys("Tang Minh Phuong");
...
(async function firstTest() {
  ...
  try {
    ...
    for (let i = 15; i < elements.length ; i++) {
      const e = elements[i]
